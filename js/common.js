...
dialog={
	...
	alertLog:function(logTitle,func){//func：为“登录”按钮动作处理函数
		dialog.showInfo("<div class='logInfo'>"
			...
			+" </ul>"
			+" <div class='infoBtn'><a class='click-btn' href='javascript:;'>登 录</a></div>"
			+"</div>");
	...
	//兑换确认弹窗
	alertChange:function(msg,func){
		dialog.showInfo("<div class='changeInfo'>"
			+" <div class='changeTips'>"+msg+"</div>"
			+"<div class='change_btn_box'><a class='ch_sure' href='javascript:"+func+";'>确 定</a><a class='ch_cancle' href='javascript:dialog.closeDiv();'>取 消</a></div>"
			+"</div>");
	}
};
